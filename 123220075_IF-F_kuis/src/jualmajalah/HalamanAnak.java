...
public class HalamanAnak extends JFrame implements ActionListener {
    
    JLabel text1 = new JLabel("Halaman Pembelian");
    JLabel text2 = new JLabel("Kategori     Halaman Anak");
    JLabel text3 = new JLabel("Harga        Rp10.000/pcs");
    ...
    JLabel textharga = new JLabel("Harga Satuan     Rp10.000/pcs");
